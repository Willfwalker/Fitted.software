...
import { applyCustomFilters } from "@/lib/utils/ui-config-helpers"
...
export default async function DealsPage({
  ...
  const uiConfig = await getUiConfig("deals")
  ...
  dealsQuery = applyCustomFilters(dealsQuery, uiConfig.filters, params)
