        ...
        >
          {state?.success ? (
            <div className="cta-form cta-success">
              ...
              <p className="cta-success-text">You&rsquo;re on the list!</p>
              <p className="cta-fine">We&rsquo;ll be in touch soon.</p>
            </div>
          ) : (
            <>
              ...
              <p className="cta-fine">Free audit. No commitment.</p>
            </>
          )}
        </motion.div>
      </div>
...
const FAQ_ITEMS = [
  {
    q: "Won\u2019t AI code quality be poor?",
    a: "AI doesn\u2019t build from scratch. The core modules are human-built with good architecture. AI only customizes on top \u2014 a much smaller surface area for errors. Strict templates, automated testing (Playwright, Jest), and periodic codebase health checks add further guardrails.",
  },
  {
    q: "How will AI test its own changes?",
    a: "Self-healing test tools (Playwright, Mabl, Testim) combined with unit tests and a CI/CD pipeline catch regressions before PRs reach review. The key decision is having a testing pipeline at all, which already puts us ahead of most agencies.",
  },
];
