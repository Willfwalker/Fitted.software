...
export const ACTIVITY_TYPE_CONFIG: Record<ActivityType, { label: string; icon: string }> = {
  ...
  TASK_STATUS_CHANGED: { label: "Task Moved", icon: "ArrowRight" },
  TASK_ASSIGNED: { label: "Task Assigned", icon: "UserCheck" },
  FILE_UPLOADED: { label: "File Uploaded", icon: "Paperclip" },
  EVENT_CREATED: { label: "Event Created", icon: "CalendarDays" },
