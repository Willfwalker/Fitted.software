...
const TYPE_CONFIG = {
  contact: { icon: Users, label: "Contacts", path: "/dashboard/crm/contacts" },
  company: { icon: Building2, label: "Companies", path: "/dashboard/crm/companies" },
  deal: { icon: Briefcase, label: "Deals", path: "/dashboard/crm/deals" },
}
